...
export default async function DashboardPage() {
  ...
  if (
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center p-4 text-center bg-black">
        <Music className="text-gray-500 h-20 w-20" />
  ...
  return (
    <div className="p-4 bg-black">
      <h1 className="text-3xl font-bold tracking-tight text-white">Discover Music</h1>

      {/* Trending songs */}
      {trendingSongs.length > 0 && (
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-blue-500">Trending</h2>
