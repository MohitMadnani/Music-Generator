...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Use hard navigation to ensure proper redirect
  ...
  return (
    <div className="min-h-screen w-full bg-black text-white">
      ...
      {/* Form Container */}
      <div className="min-h-[calc(100vh-4rem)] w-full bg-black flex items-center justify-center p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-blue-500 h-11"
                />
              </div>
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white h-11 font-medium mt-6"
              >
            ...
            <div className="mt-6">
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                <Button
                  ...
                  className="w-full bg-white/5 border-white/10 text-white hover:bg-white/10 hover:border-blue-500/50 h-11"
                >
